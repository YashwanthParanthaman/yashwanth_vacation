package com.example.yashwanth_vacation.helpers;
...
public class LocationHelper {
    ...
    public void checkPermissions(Context context) {
        ...
        if (!this.locationPermissionGranted) {
            //the app doesn't have permission to access the location
    ...
    public String getCountryCode(Context context, Location loc){
        ...
        try{
            ...
            return addressObj.getCountryCode();
        }catch(Exception ex){
